<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <ul class="menu-inner py-1" style="overflow-y: auto;overflow-x: hidden">
        ...
        @canany(['view_tahun_ajaran', 'view_prodi', 'view_rombel', 'view_kurikulum', 'view_ruang',
            'view_kelola_template_surat', 'view_kelola_mutu', 'view_kelola_kalender_akademik', 'view_kelola_sifat_ujian'])
            <li class="menu-item {{ Request::is('data-master*') ? 'active open' : '' }}">
                ...
                <ul class="menu-sub">
                    ...
                    @endcan
                    @can('view_kelola_sifat_ujian')
                        <li class="menu-item {{ Request::is('data-master/sifat-ujian*') ? 'active' : '' }}">
                            <a href="{{ route('data-master.sifat-ujian.index') }}" class="menu-link">
                                <div data-i18n="sifat-ujian">Sifat Ujian</div>
                            </a>
                        </li>
                    @endcan
                </ul>
