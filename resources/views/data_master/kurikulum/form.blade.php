...
@push('js')
    <script>
        ...
        $('.f1 .btn-next').on('click', function() {
            ...
            var next_step = $(this).hasClass('btn-selanjutnya-1') ? ($('.form-kurikulum').attr(
            ...
            parent_fieldset.find('.required').each(function() {
                if ($(this, '.select2').val() == "") {
                    $(this, '.select2').parents('.form-group').addClass('input-error');
                    next_step = false
                } else {
                    $(this, '.select2').parents('.form-group').removeClass('input-error');
                }
