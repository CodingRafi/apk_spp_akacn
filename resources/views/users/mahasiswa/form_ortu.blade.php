...
<div class="mb-3">
    ...
    <select class="form-select @error("jenjang_{$value}_id") is-invalid @enderror"
...
<div class="mb-3">
    ...
    <select class="form-select @error("pekerjaan_{$value}_id") is-invalid @enderror"
...
<div class="mb-3">
    ...
    <select class="form-select @error("penghasilan_{$value}_id") is-invalid @enderror"
    ...
    <div class="mb-3">
        ...
        <div class="d-flex gap-3">
            <div class="form-check">
                <input class="form-check-input" type="radio" name="{{ $value }}_kebutuhan_khusus" value="1" id="kps_1">
                <label class="form-check-label" for="kps_1">
                    Ya
                </label>
            </div>
            <div class="form-check">
                <input class="form-check-input" type="radio" name="{{ $value }}_kebutuhan_khusus" value="0" id="kps_0"
                    checked>
