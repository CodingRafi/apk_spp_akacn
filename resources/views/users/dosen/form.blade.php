...
<div class="tab-content py-4 px-1" id="profileContent">
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="mb-3">
                    ...
                    <input {{ $disabled ? 'disabled' : '' }} class="form-control @error('nip') is-invalid @enderror" type="text"
                ...
                <div class="mb-3">
                    ...
                    <input {{ $disabled ? 'disabled' : '' }} class="form-control @error('nama_ibu') is-invalid @enderror" type="text"
            ...
            <div class="col-md-6">
                <div class="mb-3">
                    ...
                    <input {{ $disabled ? 'disabled' : '' }} class="form-control @error('nik') is-invalid @enderror" type="text"
                ...
                <div class="mb-3">
                    ...
                    <input {{ $disabled ? 'disabled' : '' }} class="form-control @error('npwp') is-invalid @enderror" type="text"
                ...
                <div class="mb-3">
                    ...
                    <div class="d-flex gap-3">
                        <div class="form-check">
                            <input {{ $disabled ? 'disabled' : '' }} class="form-check-input" type="radio" name="status_pernikahan" value="1"
                        ...
                        <div class="form-check">
                            <input {{ $disabled ? 'disabled' : '' }} class="form-check-input" type="radio" name="status_pernikahan" value="0"
                ...
                <div class="mb-3">
                    <label for="nominal_tunjangan" class="form-label">Nominal
                        Tunjangan</label>
                    <input {{ $disabled ? 'disabled' : '' }} class="form-control @error('nominal_tunjangan') is-invalid @enderror" type="number"
    ...
    <div class="tab-pane" id="status" role="tabpanel">
        <div class="mb-3">
            ...
            <input {{ $disabled ? 'disabled' : '' }} class="form-control @error('no_sk_cpns') is-invalid @enderror" type="text"
        ...
        <div class="mb-3">
            ...
            <input {{ $disabled ? 'disabled' : '' }} class="form-control @error('tgl_sk_cpns') is-invalid @enderror" type="date"
        ...
        <div class="mb-3">
            <label for="no_sk_pengangkatan" class="form-label">No SK
                Pengangkatan</label>
            <input {{ $disabled ? 'disabled' : '' }} class="form-control @error('no_sk_pengangkatan') is-invalid @enderror" type="text"
        ...
        <div class="mb-3">
            <label for="mulai_sk_pengangkatan" class="form-label">Mulai SK
                Pengangkatan</label>
            <input {{ $disabled ? 'disabled' : '' }} class="form-control @error('mulai_sk_pengangkatan') is-invalid @enderror" type="date"
        ...
        <div class="mb-3">
            ...
            <input {{ $disabled ? 'disabled' : '' }} class="form-control @error('tgl_mulai_pns') is-invalid @enderror" type="date"
