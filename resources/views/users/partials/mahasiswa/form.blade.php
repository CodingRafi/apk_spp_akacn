            ...
            <div class="col-md-6">
                ...
                <div class="mb-3">
                    ...
                    <input class="form-control @error('tgl_lahir') is-invalid @enderror" type="date"
                        value="{{ isset($data) ? $data->mahasiswa->tgl_lahir : old('tgl_lahir') }}" id="tgl_lahir"
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input class="form-control @error('rt') is-invalid @enderror" type="text"
                                value="{{ isset($data) ? $data->mahasiswa->rt : old('rt') }}" id="rt"
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input class="form-control @error('rw') is-invalid @enderror" type="text"
                                value="{{ isset($data) ? $data->mahasiswa->rw : old('rw') }}" id="rw"
                ...
                <div class="mb-3">
                    ...
                    <input class="form-control @error('jalan') is-invalid @enderror" type="text"
                        value="{{ isset($data) ? $data->mahasiswa->jalan : old('jalan') }}" id="jalan"
                        placeholder="Jalan" name="jalan" />
                    @error('jalan')
                        <div class="invalid-feedback d-block">
                            {{ $message }}
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input class="form-control @error('dusun') is-invalid @enderror" type="text"
                                value="{{ isset($data) ? $data->mahasiswa->dusun : old('dusun') }}" id="dusun"
                                placeholder="Dusun" name="dusun" />
                            @error('dusun')
                                <div class="invalid-feedback d-block">
                                    {{ $message }}
                                </div>
                ...
                <div class="mb-3">
                    ...
                    <input class="form-control @error('kode_pos') is-invalid @enderror" type="text"
                        value="{{ isset($data) ? $data->mahasiswa->kode_pos : old('kode_pos') }}" id="kode_pos"
            ...
            <div class="col-md-6">
                <div class="mb-3">
                    ...
                    <input class="form-control @error('telepon') is-invalid @enderror" type="text"
                        value="{{ isset($data) ? $data->mahasiswa->telepon : old('telepon') }}" id="telepon"
                ...
                <div class="mb-3">
                    ...
                    <input class="form-control @error('no_kps') is-invalid @enderror" type="text"
                        ...
                        placeholder="Kode Pos" name="No KPS" />
                    @error('no_kps')
                        <div class="invalid-feedback d-block">
                            {{ $message }}
                        </div>
                ...
                <div class="mb-3">
                    ...
                    <input class="form-control @error('npwp') is-invalid @enderror" type="text"
                        ...
                        placeholder="Kode Pos" name="NPWP" />
                    @error('npwp')
                        <div class="invalid-feedback d-block">
                            {{ $message }}
                        </div>
                ...
                <div class="mb-3">
                    ...
                    <div class="form-check form-switch">
                        <input class="form-check-input" type="checkbox" role="switch" name="status"
                            id="publish" {{ isset($data) ? ($data->status ? 'checked' : '') : old('status') }}>
                    </div>
                    @error('jk')
                        <div class="invalid-feedback d-block">
                            {{ $message }}
