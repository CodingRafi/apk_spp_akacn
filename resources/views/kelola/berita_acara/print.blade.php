    ...
    <div class="daftar-hadir" style="page-break-after: always;">
        ...
        <div style="margin-top: 1rem;">
            <table aria-hidden="true" style="width: 100%">
                <tr>
                    <td style="padding: 0 auto;width: 48%;text-align: right;">Kode Mata Kuliah</td>
                    <td style="padding: 0 auto;width: 2%">:</td>
                    <td style="font-weight: bold;padding: 0 auto;width:48%;">{{ $matkul->kode }}</td>
                </tr>
                <tr>
                    <td style="padding: 0 auto;width: 48%;text-align: right;">Nama Mata Kuliah</td>
                    <td style="padding: 0 auto;width: 2%">:</td>
                    <td style="font-weight: bold;padding: 0 auto;width:48%;">{{ $matkul->nama }}</td>
                </tr>
                <tr>
                    <td style="padding: 0 auto;width: 48%;text-align: right;">Dosen Pengampu</td>
                    <td style="padding: 0 auto;width: 2%">:</td>
                    <td style="font-weight: bold;padding: 0 auto;width:48%;">{{ Auth::user()->name }}</td>
                </tr>
                <tr>
                    <td style="padding: 0 auto;width: 48%;text-align: right;">SKS</td>
                    <td style="padding: 0 auto;width: 2%">:</td>
                    <td style="font-weight: bold;padding: 0 auto;width:48%;">{{ $matkul->sks_mata_kuliah }}</td>
                </tr>
            </table>
        </div>
                ...
                <tbody>
                    @foreach ($jadwal as $item)
                        <tr>
                            ...
                            <td>
                                <table style="width: 100%;text-align: left;" aria-hidden="true">
