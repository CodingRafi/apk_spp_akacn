                ...
                <table class="content" width="100%" cellpadding="0" cellspacing="0" role="presentation"
                    ...
                    <tr>
                        <td class="header"
                            ...
                            <a href="https://testing.impstudio.id/pai-simba"
                                    ...
                                    <td class="content-cell"
                                        ...
                                        @if ($to_custom === 'mhs')
                                            ...
                                            @if ($pembayaran->status == 'diterima' || $pembayaran->status == 'ditolak')
                                                <p
                                                    style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">
                                                    <img src="{{ asset('storage/' . $pembayaran->verify->ttd) }}"
                                        ...
                                        @else
                                            <p
                                                style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">
                                                {{ $pembayaran->mahasiswa->name }} dengan NIM {{ $pembayaran->mahasiswa->login_key }} telah melakukan pembayaran sebesar {{ formatRupiah($pembayaran->nominal) }}. Klik <a href="{{ route('kelola-pembayaran.pembayaran.show', $pembayaran->id) }}">disini</a> untuk verifikasi.
                                            </p>
                                        @endif
