...
@section('container')
    ...
    <div class="content-wrapper">
        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <div class="row">
                <form
                    action="{{ isset($data) ? ($revisi ? route('pembayaran.revisi', ['type' => request('type'), 'id' => request('id'), 'pembayaran_id' => $data->id]) : route('pembayaran.update', ['type' => request('type'), 'id' => request('id'), 'pembayaran_id' => $data->id])) : route('pembayaran.store', ['type' => request('type'), 'id' => request('id')]) }}"
                                    ...
                                    <div class="d-flex justify-content-between" style="gap: 1rem;">
                                        @if ($page == 'form')
                                            <input class="form-control @error('bukti') is-invalid @enderror" type="file"
                                                value="{{ isset($data) ? $data->bukti : old('bukti') }}" id="bukti"
