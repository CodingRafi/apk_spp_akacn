...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('mbkm_dosen_pembimbing', function (Blueprint $table) {
            $table->id();
            $table->string('id_bimbing_mahasiswa_neo_feeder')->nullable();
    ...
    {
        Schema::dropIfExists('mbkm_dosen_pembimbing');
    }
};
